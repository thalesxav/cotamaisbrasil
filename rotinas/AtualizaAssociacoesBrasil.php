    ...
    class Crawler
    {
        ...
        public function BuscaAssociacoes($url)
        {
            ...
            try
            {
                ...
                //var_dump($response_a);
                $jsonAux = mysqli_real_escape_string($conn->get_link(), $response);
                $conn->exec_query("INSERT INTO PLACES (DATA, JSON) VALUES (now(), '".$jsonAux."')");    
                ...
                foreach($response_a->results as $associacao)
                {
                    ...
                    VALUES (now(), '".$jsonAux."', ".$id_requisicao.")"); 
                    //exit;
